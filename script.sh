...
CUDA_VISIBLE_DEVICES=1 python3 render.py -m output/chair_shnerf_hash_2sig/ --eval --iteration 30000 --convert_SHs_python --compute_cov3D_python
CUDA_VISIBLE_DEVICES=1 python3 render.py -m output/chair_shnerf_hash_2sig/ --eval --iteration 7000 --convert_SHs_python --compute_cov3D_python
CUDA_VISIBLE_DEVICES=1 python3 metrics.py -m output/chair_shnerf_hash_2sig/