...
#                                         --model_path output/chair_shnerf_hash_2sig_test \
#                                         --convert_SHs_python --compute_cov3D_python --encoder hashgrid
# CUDA_VISIBLE_DEVICES=0 python3 train.py -s /home/sslunder0/project/NextProject/dataset_nerf_synthetic/chair \
#         --model_path output/chair_shnerf_2s_customhash_v2 \
#         --convert_SHs_python --compute_cov3D_python --encoder hashgrid
...
CUDA_VISIBLE_DEVICES=3 python3 render.py -m output/chair_base_2sig/ --eval --iteration 30000 --convert_SHs_python --compute_cov3D_python
CUDA_VISIBLE_DEVICES=3 python3 render.py -m output/chair_base_2sig/ --eval --iteration 7000 --convert_SHs_python --compute_cov3D_python
CUDA_VISIBLE_DEVICES=3 python3 metrics.py -m output/chair_base_2sig/