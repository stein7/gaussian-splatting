...
# CUDA_VISIBLE_DEVICES=2 python3 train.py -s /home/sslunder0/project/NextProject/dataset_nerf_synthetic/chair --model_path output/chair_blender --convert_SHs_python --compute_cov3D_python
...
CUDA_VISIBLE_DEVICES=1 python3 render.py -m output/chair/ --eval --iteration 7000 --convert_SHs_python --compute_cov3D_python
